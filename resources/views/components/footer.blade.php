<footer class="footer">
    <div class="container">
        ...
        <div class="footer-social">
            ...
            <a href="{{ $portfolio['social']['instagram'] }}" target="_blank" rel="noopener noreferrer" aria-label="Visit my Instagram profile"><i class="fab fa-instagram"></i></a>
            <a href="{{ $portfolio['social']['discord'] }}" target="_blank" rel="noopener noreferrer" aria-label="Open my Discord profile"><i class="fab fa-discord"></i></a>
        </div>
